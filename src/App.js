...
function App() {
  ...
  return (
   <>
    <Navbar title="TextUtils" aboutText="AboutUs" mode={mode} btnText={btnText} toggleMode={toggleMode}/>
    <Alert alert={alert}/>
    <TextForm heading= "Enter text to analyze " mode={mode} alertMsg={alertMsg} />
    {/* <About/> */}
    {/* <Navbar/> */}
   </>
  );
